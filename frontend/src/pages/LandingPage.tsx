  ...
  return (
    <div className="flex flex-col min-h-screen">
        ...
        <div className="container mx-auto px-4 py-20 relative z-10">
          <div className="max-w-2xl">
            ...
            <p className="text-xl mb-8">
              Descubra novos destinos com o melhor em conforto, 
              segurança e preços acessíveis.
            </p>
            <div className="flex flex-wrap gap-4">
              <button 
                onClick={() => navigate('/buscarVoo')}
      ...
      <section className="bg-white py-8 shadow-md -mt-10 rounded-lg max-w-5xl mx-auto z-20 px-8">
        <h2 className="text-2xl font-bold text-gray-800 mb-4">Encontre seu próximo destino</h2>
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          ...
          <div>
            ...
            <input type="date" className="w-full border border-gray-300 rounded-md py-2 px-3 focus:ring-blue-500 focus:border-blue-500" />
          </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-12 text-gray-800">Por que escolher a FlyHigh?</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-6 rounded-lg shadow-md text-center">
              ...
              <p className="text-gray-600">Faça seu check-in online com apenas alguns cliques, economizando tempo e evitando filas.</p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md text-center">
              ...
              <p className="text-gray-600">Acumule milhas em todos os voos e troque por descontos em passagens futuras.</p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md text-center">
              ...
              <p className="text-gray-600">Viaje com tranquilidade, sabendo que sua segurança é nossa prioridade número um.</p>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <div className="relative rounded-lg overflow-hidden group h-64">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent flex items-end p-4">
                <span className="text-white font-bold text-lg">Rio de Janeiro</span>
              </div>
            </div>
      ...
      <section className="py-16 bg-gradient-to-r from-blue-600 to-blue-800 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-white-600 mb-8 max-w-2xl mx-auto">
            Planeje sua próxima viagem com a FlyHigh e descubra o prazer de voar com conforto e segurança.
          </p>

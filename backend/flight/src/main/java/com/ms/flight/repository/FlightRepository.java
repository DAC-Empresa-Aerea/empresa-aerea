...
public interface FlightRepository extends JpaRepository<Flight, String> {
    ...
    @Query("SELECT f FROM Flight f WHERE f.origem.codigo = :origem AND f.destino.codigo = :destino AND f.data >= :startDate")
    List<Flight> findByAirportAndDate(@Param("origem") String origem,

...
import com.ms.auth.config.EmailConfig;
...
public class EmailService {
    ...
    public void sendPasswordEmail (String email, String password) {
        if (!emailConfig.isActivateSend()) {
            System.out.println("ENVIO DE EMAIL DESATIVADO! APENAS EXIBINDO NO CONSOLE");
                ...
                <body style="margin:0; padding:0; font-family: Arial, sans-serif; background-color:#f4f4f4;">
                    ...
                    <tr>
                        <td align="center" bgcolor="#1e90ff" style="padding: 20px 0; border-top-left-radius: 8px; border-top-right-radius: 8px;">
                            <p style="color:#ffffff; font-size:24px; margin:0;">FlyHigh</p>
                        </td>
                    </tr>
                    <tr>
